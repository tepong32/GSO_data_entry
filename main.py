...
if file_path:
    ...
    df = pd.read_excel('your_excel_file.xlsx', sheet_name='DoNotSelectThis')

    # Extract the "Peripherals" column
...
month = ttk.Entry(widgets_frame, width=10)
...
btn_load.grid(row=0, column=8, padx=5, pady=(0, 5), sticky="ew")
